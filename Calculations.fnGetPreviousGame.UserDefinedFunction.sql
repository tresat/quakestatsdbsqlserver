/****** Object:  UserDefinedFunction [Calculations].[fnGetPreviousGame]    Script Date: 04/19/2009 22:48:42 ******/
SET ANSI_NULLS ON
GO
...
-- Author:		tom
-- Create date: 3/22/09
-- Description:	Links a game to its previous game.  This requires uppage adjacencies to already be set.
-- =============================================
