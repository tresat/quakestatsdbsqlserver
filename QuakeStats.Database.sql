USE [master]
GO
/****** Object:  Database [QuakeStats]    Script Date: 03/22/2009 17:07:47 ******/
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = N'QuakeStats')
BEGIN
CREATE DATABASE [QuakeStats] ON  PRIMARY 
( NAME = N'QuakeStats', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\DATA\QuakeStats.mdf' , SIZE = 2048KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB ), 
 FILEGROUP [CALCULATED_DATA] 
( NAME = N'QuakeStats_CalculatedData', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\DATA\QuakeStats_CalculatedData.ndf' , SIZE = 113664KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB ), 
...
( NAME = N'QuakeStats_SiteData', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\DATA\QuakeStats_SiteData.ndf' , SIZE = 102400KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'QuakeStats_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\DATA\QuakeStats_log.ldf' , SIZE = 568896KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
END
GO
